function bfuniteu(){
  ...
  bfuniteu.__moduleName = $intern_4;
  bfuniteu.__errFn = null;
  bfuniteu.__moduleBase = $intern_6;
  bfuniteu.__softPermutationId = $intern_7;
    ...
    function installCode(code_0){
      ...
      if (bfuniteu.__errFn) {
        script.onerror = function(){
          bfuniteu.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  function getCompiledCodeFilename(){
    ...
    $wnd.__gwt_activeModules[$intern_4].bindings = bfuniteu.__getPropMap;
    ...
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_53], $intern_65 + $intern_66);
      unflattenKeylistIntoAnswers([$intern_57], $intern_65 + $intern_67);
      unflattenKeylistIntoAnswers([$intern_55], $intern_65 + $intern_68);
      unflattenKeylistIntoAnswers([$intern_49], $intern_65 + $intern_69);
  ...
  activeModules[$intern_4].moduleBase = bfuniteu.__moduleBase;
